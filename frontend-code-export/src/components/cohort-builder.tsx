  ...
  const sevenPillars = [
    {
      ...
      name: '1P Data',
      icon: Database,
      description: 'Purchase data, CRM insights, customer behavior',
    ...
    },
    {
      ...
      name: 'Competitive',
      icon: Target,
      description: 'Competitor buyers, loyalists, and advocates',
    ...
    },
    {
      ...
      name: 'Regional',
      icon: MapPin,
      description: 'Geo-specific opportunities and expanding locations',
      examples: ['Texas millennials', 'Urban northeast', 'Emerging markets']
    },
    {
      id: 'lifestage',
      name: 'Lifestage/Mindset',
      icon: Brain,
      description: 'Qualitative insights, sentiment, unmet needs',
      examples: ['New parents', 'Career climbers', 'Health-conscious adults']
    },
    {
      id: 'category',
      name: 'Category Behaviors',
      icon: Tag,
      description: 'Category signals, interests, habits & routines',
    ...
    },
    {
      ...
      name: 'Platforms',
      icon: Smartphone,
      description: 'Platform usage, content formats, themes',
    ...
    },
    {
      ...
      name: 'Wildcard',
      icon: Sparkles,
      description: 'Anything goes! Unique cultural moments',
