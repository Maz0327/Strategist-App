    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-gray-600 mb-3">Project data, analytics, and client performance metrics</p>
            {projectLoading ? (
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  {projectData.feedItems.slice(0, 3).map((item: any) => (
                    <div key={item.id} className="text-sm border-l-2 border-blue-500 pl-3 py-1">
                      <div className="font-medium text-gray-900 truncate">{item.title}</div>
                      <div className="text-gray-600 text-xs">{formatDistanceToNow(new Date(item.publishedAt))} ago</div>
                    </div>
                  ))}
                </div>
              ) : (
                <div className="text-center py-4">
                  ...
                  <p className="text-sm text-gray-600">No client data available</p>
                </div>
              )}
            </CardContent>
          </Card>
        ...
        <Card>
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg">Custom Feeds</CardTitle>
                <Button 
                  variant="outline" 
                  size="sm"
            ...
            <CardContent>
              <p className="text-sm text-gray-600 mb-3">RSS feeds, newsletters, and custom data sources</p>
              {customLoading ? (
                <div className="space-y-2">
                  {[1, 2, 3].map(i => (
                    <div key={i} className="h-3 bg-gray-200 rounded animate-pulse"></div>
                ...
                <div className="space-y-2">
                  {customFeedData.feedItems.slice(0, 3).map((item: any) => (
                    <div key={item.id} className="text-sm border-l-2 border-green-500 pl-3 py-1">
                      <div className="font-medium text-gray-900 truncate">{item.title}</div>
                      <div className="text-gray-600 text-xs">{formatDistanceToNow(new Date(item.publishedAt))} ago</div>
                    </div>
                  ))}
                ...
                <div className="text-center py-4">
                  ...
                  <p className="text-sm text-gray-600">No custom feeds configured</p>
                </div>
              )}
            </CardContent>
          </Card>
      ...
      <Card>
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                ...
                <Button 
                  variant="outline" 
                  size="sm"
                  onClick={() => onNavigate?.("feeds", "intelligence-feeds")}
                  className="flex items-center gap-2"
                >
                  <ExternalLink className="w-4 h-4" />
                  View All
            ...
            <CardContent>
              <p className="text-sm text-gray-600 mb-3">Market trends, competitive insights, and strategic intelligence</p>
              {intelligenceLoading ? (
                <div className="space-y-2">
                  {[1, 2, 3].map(i => (
                    <div key={i} className="h-3 bg-gray-200 rounded animate-pulse"></div>
                ...
                <div className="space-y-2">
                  {intelligenceData.feedItems.slice(0, 3).map((item: any) => (
                    <div key={item.id} className="text-sm border-l-2 border-purple-500 pl-3 py-1">
                      <div className="font-medium text-gray-900 truncate">{item.title}</div>
                      <div className="text-gray-600 text-xs">{formatDistanceToNow(new Date(item.publishedAt))} ago</div>
                    </div>
                  ))}
                ...
                <div className="text-center py-4">
                  ...
                  <p className="text-sm text-gray-600">No intelligence data available</p>
                </div>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                ...
                <Button 
                  variant="outline" 
                  size="sm"
                  onClick={() => onNavigate?.("manage", "signals")}
                  className="flex items-center gap-2"
                >
                  <ExternalLink className="w-4 h-4" />
                  View All
            ...
            <CardContent>
              <p className="text-sm text-gray-600 mb-3">Your latest analyzed content and signals</p>
              {isLoading ? (
                <div className="space-y-2">
                  {[1, 2, 3].map(i => (
                    <div key={i} className="h-3 bg-gray-200 rounded animate-pulse"></div>
                ...
                <div className="space-y-2">
                  {signalsData.signals.slice(0, 3).map((signal: Signal) => (
                    <div key={signal.id} className="text-sm border-l-2 border-orange-500 pl-3 py-1">
                      <div className="font-medium text-gray-900 truncate">{signal.title}</div>
                      <div className="text-gray-600 text-xs">{formatDistanceToNow(new Date(signal.createdAt))} ago</div>
                    </div>
                  ))}
                </div>
              ) : (
                <div className="text-center py-4">
                  ...
                  <p className="text-sm text-gray-600">No signals captured yet</p>
                  <Button 
                    variant="outline" 
                    size="sm"
