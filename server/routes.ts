...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // MVP SIMPLIFIED - All audio endpoints temporarily removed to focus on core functionality
  /* MVP SIMPLIFIED - Audio transcription temporarily disabled
  ...
  */ // MVP SIMPLIFIED - End of audio transcription block

  /* MVP SIMPLIFIED - Audio signals temporarily disabled
  ...
  */ // MVP SIMPLIFIED - End of audio signals block

  /* MVP SIMPLIFIED - Whisper transcription temporarily disabled
...
*Brief generated using ${validSignals.length} signals*`;
  ...
  app.post("/api/rss-feeds", requireAuth, async (req, res) => {
    try {
      ...
      const { rssService } = await import('./services/rss-service-simple');
